...
namespace Aiv.Fast2D.Example.Alien
{
    class AlienExample
    {
        ...
        public class Example
        {
            ...
            public Example()
            {
                ...
                window.SetIcon("Aiv.Fast2D.Example.Alien.Assets.2.ico");

                window.Position = new Vector2(0, 0);

                //window.SetCursor(false);

                logoAiv = new Texture("Aiv.Fast2D.Example.Alien.Assets.LogoAIV.png");


                alien = new Texture("Aiv.Fast2D.Example.Alien.Assets.owl.png");
                ...
                alien2 = new Texture("Aiv.Fast2D.Example.Alien.Assets.2.png");
                maskedAlien = new RenderTexture(alien2.Width, alien2.Height);
                spriteMask = new Sprite(50, 50);

                circleMask = new Texture("Aiv.Fast2D.Example.Alien.Assets.mask_circle.png");
                circleMask2 = new Texture("Aiv.Fast2D.Example.Alien.Assets.mask_circle2.png");
                ...
                window.AddPostProcessingEffect(new MaskEffect("Aiv.Fast2D.Example.Alien.Assets.mask_circle.png"));
                ...
                tileMap = new Tilemap("Alien/Assets/map001.csv", "Alien/Assets/tiles_spritesheet.png");
            }
